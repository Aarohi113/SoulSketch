...
const TestimonialSection = () => {
  const originalData = [
    { id: 1, name: "Meera J.", text: "முழுமையாக அதிசயமான ஓவியம். வழங்கப்பட்ட ஆன்மீக வாசிப்பு எனக் கூட தேடும் என்று நான் கூட நினைக்காத தெளிவை கொடுத்தது. " },
    ...
    { id: 3, name: "Isha V.", text: "இது வெறும் வரைபடம் அல்ல; இது ஒரு நம்பிக்கையின் துண்டு. வாசிப்பு மிகவும் நேர்மறை மற்றும் என் உணர்வுகளோடு பொருந்தியது. " },
    { id: 4, name: "Rahul S.", text: "தொடக்கத்தில் நான் சந்தேகப்பட்டிருந்தேன், ஆனால் வரைபடத்தில் உள்ள விவரங்கள் அதிசயமாக இருந்தது." },
          ...
          >
            {testimonials.map((item, index) => (
              <div key={index} className="min-w-full md:min-w-[33.333%] px-3 box-border">
                <div className="bg-[#f4c6cdff] p-8 rounded-2xl shadow-sm border border-red-50 h-[480px] flex flex-col justify-between">
                  <div>
